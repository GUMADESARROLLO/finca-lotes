  ...
  <AuthenticatedLayout>
    ...
    <div class="px-0 md:px-0">
      <div class="flex items-center gap-4 mb-6">
        ...
        <div>
          <h2 class="text-2xl text-primary font-bold">Editar Lote</h2>
          <p class="text-sm text-on-surface-variant">{{ lote.codigo }} — {{ lote.nombre }}</p>
        </div>
      </div>
      ...
      <form @submit.prevent="submit" class="space-y-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
          ...
          <div class="bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant/30 p-6 space-y-4 flex flex-col">
            ...
            <div ref="mapContainer" id="edit-map" class="w-full flex-1 min-h-[300px] rounded-lg border border-outline-variant z-10 relative"></div>
        ...
        <div class="flex items-center gap-4 pb-8">
          ...
          <Link :href="route('lotes.index')" class="h-12 px-6 border border-outline-variant text-on-surface-variant rounded-lg hover:bg-surface-container-low transition-all flex items-center">
            Cancelar
          </Link>
        </div>
      </form>

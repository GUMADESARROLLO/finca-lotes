  ...
  <AuthenticatedLayout>
    ...
    <div class="px-0 md:px-0">
      <div class="flex items-center gap-4 mb-6">
        ...
        <div>
          <h2 class="text-2xl text-[#0f5238] font-bold">Nuevo Lote</h2>
          <p class="text-sm text-[#404943]">Dibuje el perímetro del lote en el mapa.</p>
        </div>
      </div>
      ...
      <form @submit.prevent="submit" class="space-y-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
          ...
          <div class="bg-white rounded-xl shadow-sm border border-[#bfc9c1]/30 p-6 space-y-4 flex flex-col">
            ...
            <div ref="mapContainer" id="create-map" class="w-full flex-1 min-h-[300px] rounded-lg border border-[#bfc9c1] z-10 relative"></div>
        ...
        <div class="flex items-center gap-4 pb-8">
          ...
          <Link :href="route('lotes.index')"
            class="h-12 px-6 border border-[#bfc9c1] text-[#404943] rounded-lg hover:bg-[#f6f4ec] transition-all flex items-center">
            Cancelar
          </Link>
        </div>
      </form>
